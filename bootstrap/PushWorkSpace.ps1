...
$PackWorkspaceCmd = "${BuildDir}\src\scxcore\build\Tools\7zip\7z.exe -r -ttar a ${WorkspaceArchive} ${BuildDir}\src\* -xr!Target\*"
...
$PushUnpackCmd = "$TransferExec -q -C -l $BuildUser -pw $BuildUserPW ${BuildDir}\src\scxcore\bootstrap\${UnpackScriptName} $BuildHost`:${QualifiedUnpackScriptName}"
