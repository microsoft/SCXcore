...
class CIM_EthernetPort_Class : public CIM_NetworkPort_Class
{
public:
    
    typedef CIM_EthernetPort Self;
    
    CIM_EthernetPort_Class() :
        CIM_NetworkPort_Class(&CIM_EthernetPort_rtti)
    {
    }
    
    CIM_EthernetPort_Class(
        const CIM_EthernetPort* instanceName,
        bool keysOnly) :
    ...
    CIM_EthernetPort_Class(
        ...
        bool keysOnly) :
        CIM_NetworkPort_Class(clDecl, instance, keysOnly)
    {
    }
    
    CIM_EthernetPort_Class(
        const MI_ClassDecl* clDecl) :
        CIM_NetworkPort_Class(clDecl)
    {
    }
    
    CIM_EthernetPort_Class& operator=(
        const CIM_EthernetPort_Class& x)
    {
        CopyRef(x);
        return *this;
    }
    ...
    CIM_EthernetPort_Class(
        const CIM_EthernetPort_Class& x) :
        CIM_NetworkPort_Class(x)
    {
    }

    static const MI_ClassDecl* GetClassDecl()
    {
        return &CIM_EthernetPort_rtti;
    }

    //
    // CIM_EthernetPort_Class.MaxDataSize
    //
    ...
    //
    // CIM_EthernetPort_Class.Capabilities
    //
    ...
    //
    // CIM_EthernetPort_Class.CapabilityDescriptions
    //
    ...
    //
    // CIM_EthernetPort_Class.EnabledCapabilities
    //
    
    const Field<Uint16A>& EnabledCapabilities() const
    {
        const size_t n = offsetof(Self, EnabledCapabilities);
        return GetField<Uint16A>(n);
    }
    
    void EnabledCapabilities(const Field<Uint16A>& x)
    {
        const size_t n = offsetof(Self, EnabledCapabilities);
        GetField<Uint16A>(n) = x;
    }
    
    const Uint16A& EnabledCapabilities_value() const
    {
        const size_t n = offsetof(Self, EnabledCapabilities);
        return GetField<Uint16A>(n).value;
    }
    
    void EnabledCapabilities_value(const Uint16A& x)
    {
        const size_t n = offsetof(Self, EnabledCapabilities);
        GetField<Uint16A>(n).Set(x);
    }
    
    bool EnabledCapabilities_exists() const
    {
        const size_t n = offsetof(Self, EnabledCapabilities);
        return GetField<Uint16A>(n).exists ? true : false;
    }
    
    void EnabledCapabilities_clear()
    {
        const size_t n = offsetof(Self, EnabledCapabilities);
        GetField<Uint16A>(n).Clear();
    }
    ...
    //
    // CIM_EthernetPort_Class.OtherEnabledCapabilities
    //
    
    const Field<StringA>& OtherEnabledCapabilities() const
    {
        const size_t n = offsetof(Self, OtherEnabledCapabilities);
        return GetField<StringA>(n);
    }
    
    void OtherEnabledCapabilities(const Field<StringA>& x)
    {
        const size_t n = offsetof(Self, OtherEnabledCapabilities);
        GetField<StringA>(n) = x;
    }
    
    const StringA& OtherEnabledCapabilities_value() const
    {
        const size_t n = offsetof(Self, OtherEnabledCapabilities);
        return GetField<StringA>(n).value;
    }
    
    void OtherEnabledCapabilities_value(const StringA& x)
    {
        const size_t n = offsetof(Self, OtherEnabledCapabilities);
        GetField<StringA>(n).Set(x);
    }
    
    bool OtherEnabledCapabilities_exists() const
    {
        const size_t n = offsetof(Self, OtherEnabledCapabilities);
        return GetField<StringA>(n).exists ? true : false;
    }
    
    void OtherEnabledCapabilities_clear()
    {
        const size_t n = offsetof(Self, OtherEnabledCapabilities);
        GetField<StringA>(n).Clear();
    }
...
typedef Array<CIM_EthernetPort_Class> CIM_EthernetPort_ClassA;
