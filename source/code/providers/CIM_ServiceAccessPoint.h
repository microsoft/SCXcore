...
class CIM_ServiceAccessPoint_Class : public CIM_EnabledLogicalElement_Class
{
public:
    
    typedef CIM_ServiceAccessPoint Self;
    
    CIM_ServiceAccessPoint_Class() :
        CIM_EnabledLogicalElement_Class(&CIM_ServiceAccessPoint_rtti)
    {
    }
    
    CIM_ServiceAccessPoint_Class(
        const CIM_ServiceAccessPoint* instanceName,
        bool keysOnly) :
    ...
    CIM_ServiceAccessPoint_Class& operator=(
        const CIM_ServiceAccessPoint_Class& x)
    {
        CopyRef(x);
        return *this;
    }
    ...
    {
        return &CIM_ServiceAccessPoint_rtti;
    }

    //
    // CIM_ServiceAccessPoint_Class.SystemCreationClassName
    //
    ...
    //
    // CIM_ServiceAccessPoint_Class.SystemName
    //
    ...
    //
    // CIM_ServiceAccessPoint_Class.CreationClassName
    //
...
typedef Array<CIM_ServiceAccessPoint_Class> CIM_ServiceAccessPoint_ClassA;
