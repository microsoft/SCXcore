...
class CIM_NetworkPort_Class : public CIM_LogicalPort_Class
{
public:
    
    typedef CIM_NetworkPort Self;
    
    CIM_NetworkPort_Class() :
        CIM_LogicalPort_Class(&CIM_NetworkPort_rtti)
    {
    }
    
    CIM_NetworkPort_Class(
        const CIM_NetworkPort* instanceName,
        bool keysOnly) :
    ...
    CIM_NetworkPort_Class(
        ...
        bool keysOnly) :
        CIM_LogicalPort_Class(clDecl, instance, keysOnly)
    {
    }
    
    CIM_NetworkPort_Class(
        const MI_ClassDecl* clDecl) :
        CIM_LogicalPort_Class(clDecl)
    {
    }
    
    CIM_NetworkPort_Class& operator=(
        const CIM_NetworkPort_Class& x)
    {
        CopyRef(x);
        return *this;
    }
    ...
    CIM_NetworkPort_Class(
        const CIM_NetworkPort_Class& x) :
        CIM_LogicalPort_Class(x)
    {
    }

    static const MI_ClassDecl* GetClassDecl()
    {
        return &CIM_NetworkPort_rtti;
    }

    //
    // CIM_NetworkPort_Class.OtherNetworkPortType
    //
    
    const Field<String>& OtherNetworkPortType() const
    {
        const size_t n = offsetof(Self, OtherNetworkPortType);
        return GetField<String>(n);
    }
    
    void OtherNetworkPortType(const Field<String>& x)
    {
        const size_t n = offsetof(Self, OtherNetworkPortType);
        GetField<String>(n) = x;
    }
    
    const String& OtherNetworkPortType_value() const
    {
        const size_t n = offsetof(Self, OtherNetworkPortType);
        return GetField<String>(n).value;
    }
    
    void OtherNetworkPortType_value(const String& x)
    {
        const size_t n = offsetof(Self, OtherNetworkPortType);
        GetField<String>(n).Set(x);
    }
    
    bool OtherNetworkPortType_exists() const
    {
        const size_t n = offsetof(Self, OtherNetworkPortType);
        return GetField<String>(n).exists ? true : false;
    }
    
    void OtherNetworkPortType_clear()
    {
        const size_t n = offsetof(Self, OtherNetworkPortType);
    ...
    //
    // CIM_NetworkPort_Class.PortNumber
    //
    
    const Field<Uint16>& PortNumber() const
    {
        const size_t n = offsetof(Self, PortNumber);
        return GetField<Uint16>(n);
    }
    
    void PortNumber(const Field<Uint16>& x)
    {
        const size_t n = offsetof(Self, PortNumber);
        GetField<Uint16>(n) = x;
    }
    
    const Uint16& PortNumber_value() const
    {
        const size_t n = offsetof(Self, PortNumber);
        return GetField<Uint16>(n).value;
    }
    
    void PortNumber_value(const Uint16& x)
    {
        const size_t n = offsetof(Self, PortNumber);
        GetField<Uint16>(n).Set(x);
    }
    
    bool PortNumber_exists() const
    {
        const size_t n = offsetof(Self, PortNumber);
        return GetField<Uint16>(n).exists ? true : false;
    }
    
    void PortNumber_clear()
    {
        const size_t n = offsetof(Self, PortNumber);
    ...
    //
    // CIM_NetworkPort_Class.LinkTechnology
    //
    
    const Field<Uint16>& LinkTechnology() const
    {
        const size_t n = offsetof(Self, LinkTechnology);
        return GetField<Uint16>(n);
    }
    
    void LinkTechnology(const Field<Uint16>& x)
    {
        const size_t n = offsetof(Self, LinkTechnology);
        GetField<Uint16>(n) = x;
    }
    
    const Uint16& LinkTechnology_value() const
    {
        const size_t n = offsetof(Self, LinkTechnology);
        return GetField<Uint16>(n).value;
    }
    
    void LinkTechnology_value(const Uint16& x)
    {
        const size_t n = offsetof(Self, LinkTechnology);
        GetField<Uint16>(n).Set(x);
    }
    
    bool LinkTechnology_exists() const
    {
        const size_t n = offsetof(Self, LinkTechnology);
        return GetField<Uint16>(n).exists ? true : false;
    }
    
    void LinkTechnology_clear()
    {
        const size_t n = offsetof(Self, LinkTechnology);
        GetField<Uint16>(n).Clear();
    }
    ...
    //
    // CIM_NetworkPort_Class.OtherLinkTechnology
    //
    
    const Field<String>& OtherLinkTechnology() const
    {
        const size_t n = offsetof(Self, OtherLinkTechnology);
        return GetField<String>(n);
    }
    
    void OtherLinkTechnology(const Field<String>& x)
    {
        const size_t n = offsetof(Self, OtherLinkTechnology);
        GetField<String>(n) = x;
    }
    
    const String& OtherLinkTechnology_value() const
    {
        const size_t n = offsetof(Self, OtherLinkTechnology);
        return GetField<String>(n).value;
    }
    
    void OtherLinkTechnology_value(const String& x)
    {
        const size_t n = offsetof(Self, OtherLinkTechnology);
        GetField<String>(n).Set(x);
    }
    
    bool OtherLinkTechnology_exists() const
    {
        const size_t n = offsetof(Self, OtherLinkTechnology);
        return GetField<String>(n).exists ? true : false;
    }
    
    void OtherLinkTechnology_clear()
    {
        const size_t n = offsetof(Self, OtherLinkTechnology);
        GetField<String>(n).Clear();
    }
    ...
    //
    // CIM_NetworkPort_Class.PermanentAddress
    //
    
    const Field<String>& PermanentAddress() const
    {
        const size_t n = offsetof(Self, PermanentAddress);
        return GetField<String>(n);
    }
    
    void PermanentAddress(const Field<String>& x)
    {
        const size_t n = offsetof(Self, PermanentAddress);
        GetField<String>(n) = x;
    }
    
    const String& PermanentAddress_value() const
    {
        const size_t n = offsetof(Self, PermanentAddress);
        return GetField<String>(n).value;
    }
    
    void PermanentAddress_value(const String& x)
    {
        const size_t n = offsetof(Self, PermanentAddress);
        GetField<String>(n).Set(x);
    }
    
    bool PermanentAddress_exists() const
    {
        const size_t n = offsetof(Self, PermanentAddress);
        return GetField<String>(n).exists ? true : false;
    }
    
    void PermanentAddress_clear()
    {
        const size_t n = offsetof(Self, PermanentAddress);
        GetField<String>(n).Clear();
    }
    ...
    //
    // CIM_NetworkPort_Class.NetworkAddresses
    //
    
    const Field<StringA>& NetworkAddresses() const
    {
        const size_t n = offsetof(Self, NetworkAddresses);
        return GetField<StringA>(n);
    }
    
    void NetworkAddresses(const Field<StringA>& x)
    {
        const size_t n = offsetof(Self, NetworkAddresses);
        GetField<StringA>(n) = x;
    }
    
    const StringA& NetworkAddresses_value() const
    {
        const size_t n = offsetof(Self, NetworkAddresses);
        return GetField<StringA>(n).value;
    }
    
    void NetworkAddresses_value(const StringA& x)
    {
        const size_t n = offsetof(Self, NetworkAddresses);
        GetField<StringA>(n).Set(x);
    }
    
    bool NetworkAddresses_exists() const
    {
        const size_t n = offsetof(Self, NetworkAddresses);
        return GetField<StringA>(n).exists ? true : false;
    }
    
    void NetworkAddresses_clear()
    {
        const size_t n = offsetof(Self, NetworkAddresses);
    ...
    //
    // CIM_NetworkPort_Class.FullDuplex
    //
    
    const Field<Boolean>& FullDuplex() const
    {
        const size_t n = offsetof(Self, FullDuplex);
        return GetField<Boolean>(n);
    }
    
    void FullDuplex(const Field<Boolean>& x)
    {
        const size_t n = offsetof(Self, FullDuplex);
        GetField<Boolean>(n) = x;
    }
    
    const Boolean& FullDuplex_value() const
    {
        const size_t n = offsetof(Self, FullDuplex);
        return GetField<Boolean>(n).value;
    }
    
    void FullDuplex_value(const Boolean& x)
    {
        const size_t n = offsetof(Self, FullDuplex);
        GetField<Boolean>(n).Set(x);
    }
    
    bool FullDuplex_exists() const
    {
        const size_t n = offsetof(Self, FullDuplex);
        return GetField<Boolean>(n).exists ? true : false;
    }
    
    void FullDuplex_clear()
    {
        const size_t n = offsetof(Self, FullDuplex);
    ...
    //
    // CIM_NetworkPort_Class.AutoSense
    //
    
    const Field<Boolean>& AutoSense() const
    {
        const size_t n = offsetof(Self, AutoSense);
        return GetField<Boolean>(n);
    }
    
    void AutoSense(const Field<Boolean>& x)
    {
        const size_t n = offsetof(Self, AutoSense);
        GetField<Boolean>(n) = x;
    }
    
    const Boolean& AutoSense_value() const
    {
        const size_t n = offsetof(Self, AutoSense);
        return GetField<Boolean>(n).value;
    }
    
    void AutoSense_value(const Boolean& x)
    {
        const size_t n = offsetof(Self, AutoSense);
        GetField<Boolean>(n).Set(x);
    }
    
    bool AutoSense_exists() const
    {
        const size_t n = offsetof(Self, AutoSense);
        return GetField<Boolean>(n).exists ? true : false;
    }
    
    void AutoSense_clear()
    {
        const size_t n = offsetof(Self, AutoSense);
        GetField<Boolean>(n).Clear();
    }
    ...
    //
    // CIM_NetworkPort_Class.SupportedMaximumTransmissionUnit
    //
    
    const Field<Uint64>& SupportedMaximumTransmissionUnit() const
    {
        const size_t n = offsetof(Self, SupportedMaximumTransmissionUnit);
        return GetField<Uint64>(n);
    }
    
    void SupportedMaximumTransmissionUnit(const Field<Uint64>& x)
    {
        const size_t n = offsetof(Self, SupportedMaximumTransmissionUnit);
        GetField<Uint64>(n) = x;
    }
    
    const Uint64& SupportedMaximumTransmissionUnit_value() const
    {
        const size_t n = offsetof(Self, SupportedMaximumTransmissionUnit);
        return GetField<Uint64>(n).value;
    }
    
    void SupportedMaximumTransmissionUnit_value(const Uint64& x)
    {
        const size_t n = offsetof(Self, SupportedMaximumTransmissionUnit);
        GetField<Uint64>(n).Set(x);
    }
    
    bool SupportedMaximumTransmissionUnit_exists() const
    {
        const size_t n = offsetof(Self, SupportedMaximumTransmissionUnit);
        return GetField<Uint64>(n).exists ? true : false;
    }
    
    void SupportedMaximumTransmissionUnit_clear()
    {
        const size_t n = offsetof(Self, SupportedMaximumTransmissionUnit);
    ...
    //
    // CIM_NetworkPort_Class.ActiveMaximumTransmissionUnit
    //
    
    const Field<Uint64>& ActiveMaximumTransmissionUnit() const
    {
        const size_t n = offsetof(Self, ActiveMaximumTransmissionUnit);
        return GetField<Uint64>(n);
    }
    
    void ActiveMaximumTransmissionUnit(const Field<Uint64>& x)
    {
        const size_t n = offsetof(Self, ActiveMaximumTransmissionUnit);
        GetField<Uint64>(n) = x;
    }
    
    const Uint64& ActiveMaximumTransmissionUnit_value() const
    {
        const size_t n = offsetof(Self, ActiveMaximumTransmissionUnit);
        return GetField<Uint64>(n).value;
    }
    
    void ActiveMaximumTransmissionUnit_value(const Uint64& x)
    {
        const size_t n = offsetof(Self, ActiveMaximumTransmissionUnit);
        GetField<Uint64>(n).Set(x);
    }
    
    bool ActiveMaximumTransmissionUnit_exists() const
    {
        const size_t n = offsetof(Self, ActiveMaximumTransmissionUnit);
        return GetField<Uint64>(n).exists ? true : false;
    }
    
    void ActiveMaximumTransmissionUnit_clear()
    {
        const size_t n = offsetof(Self, ActiveMaximumTransmissionUnit);
        GetField<Uint64>(n).Clear();
    }
...
typedef Array<CIM_NetworkPort_Class> CIM_NetworkPort_ClassA;
