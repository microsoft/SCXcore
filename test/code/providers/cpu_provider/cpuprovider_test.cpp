...
public:
    void setUp(void)
    {
        ...
        SetUpAgent<mi::SCX_ProcessorStatisticalInformation_Class_Provider>(CALL_LOCATION(errMsg));
    ...
    {
        std::wostringstream errMsg;
        TearDownAgent<mi::SCX_ProcessorStatisticalInformation_Class_Provider>(CALL_LOCATION(errMsg));
    }
